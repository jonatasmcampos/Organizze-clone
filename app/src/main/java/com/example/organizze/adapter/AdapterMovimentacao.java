...
public class AdapterMovimentacao extends RecyclerView.Adapter<AdapterMovimentacao.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            titulo = itemView.findViewById(com.example.organizze.R.id.textAdapterTitulo);
            valor = itemView.findViewById(com.example.organizze.R.id.textAdapterValor);
            categoria = itemView.findViewById(com.example.organizze.R.id.textAdapterCategoria);
        }
